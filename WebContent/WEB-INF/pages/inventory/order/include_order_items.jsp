...
<table class="plain">
  ...
  <tr>
    ...
    <td>Amount:</td>
    <td><input id="editItemAmount" type="text" size="20"/></td>
  </tr>
  <tr>
    <td>Unit Price:</td>
    <td><input id="editItemUnitPrice" type="text" size="20"/></td>
  
    <td>Total Cost:</td>
    <td><input id="editItemTotalCost" type="text" size="20"/></td>
  </tr>
  <tr>
    <td>Supplier:</td>
  ...
  <tr>
    <td colspan="2" align="right">
      <span id="id"></span>
      <input type="button" value="Add New" onclick="addOrderItem()"/>
      <input type="button" value="Save Changes" onclick="saveOrderItem()"/>
      <input type="button" value="Clear" onclick="clearOrderItem()"/>
   </td>
  </tr>
</table>
</form>
<v:javascript formName="orderItemDetail" staticJavascript="false"/>
</div>
...
<ul>
    <li class="buttonBar right">
        ...
        <c:if test="${managedOrder!=null && managedOrder.id!=null && requestScope['principal_key'].isSuperUser && managedOrder.status!=null && managedOrder.status=='2_order_submitted'}">
        ...
        <c:if test="${managedOrder!=null && managedOrder.id!=null && managedOrder.status!=null && managedOrder.status=='5_order_approved'}">
	...
	<li>
		...
		<div>
            ...
            <form:input path="totalPrice" id="totalPrice" cssClass="text medium" cssErrorClass="text medium error" maxlength="50" readonly="true"/>
        </div>
    </li>
    <li>
        <div class="left">

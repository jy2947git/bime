...
<ul>
    <li class="buttonBar right">
        ...
        <c:if test="${param.from == 'list' and param.method != 'Add'}">
            <input type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete('storage')"
    ...
    <li class="info">
        <c:choose>
            <c:when test="${param.from == 'list'}">
                <p><fmt:message key="storage.update.message"/></p>
            </c:when>
            <c:otherwise>
                <p><fmt:message key="storage.add.message"/></p>
            </c:otherwise>
        </c:choose>
    </li>
...
<jsp:include page="include_storage_sections.jsp"></jsp:include>
...
<v:javascript formName="storage" staticJavascript="false"/>

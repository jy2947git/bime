...
create table equiptment (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, equiptmentCondition varchar(50), lastMaintainenceDate datetime, location varchar(50), maintainenceTools varchar(200), name varchar(50) not null, nextMaintanenceDate datetime, type varchar(50) not null, contactPerson_id bigint, lastUser_id bigint, primary key (id));
...
alter table equiptment add index FKC53AF1A2E148D9DB (lastUser_id), add constraint FKC53AF1A2E148D9DB foreign key (lastUser_id) references app_user (id);
alter table equiptment add index FKC53AF1A292128D47 (contactPerson_id), add constraint FKC53AF1A292128D47 foreign key (contactPerson_id) references app_user (id);

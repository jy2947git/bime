...
create table WorkMonthlyPlan (id bigint not null, primary key (id));
create table WorkWeeklyPlan (id bigint not null, work_monthly_plan_id bigint, primary key (id));
create table app_user (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, account_expired bit not null, account_locked bit not null, cellPhoneNumber varchar(255), credentials_expired bit not null, email varchar(255), account_enabled bit, first_name varchar(50) not null, homePhoneNumber varchar(255), last_name varchar(50) not null, password varchar(255) not null, password_hint varchar(255), startDate datetime, superUserId bigint, title varchar(255), username varchar(50) not null unique, workPhoneNumber varchar(255), primary key (id));
...
create table experiment_note (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, endDate datetime, name varchar(255), notes text, startDate datetime, user_id bigint, managed_project_id bigint, experiment_protocol_id bigint, primary key (id));
create table experiment_protocol (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, createdByName varchar(50), experimentProcedure text, name varchar(50) not null, protocolVersion integer not null, managed_project_id bigint, primary key (id));
create table experiment_protocol_audit (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, message text not null, experiment_protocol_id bigint, primary key (id));
...
create table inventory_audit (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, message text, managed_item_id bigint, primary key (id));
...
create table lab_meetin_item (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, itemOrder integer, topic varchar(255), speaker_id bigint, lab_meeting_id bigint, primary key (id));
create table lab_meeting (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, endCalendar datetime, message text, startCalendar datetime, subject varchar(50), coordinator_id bigint, primary key (id));
...
create table order_item (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, amount integer not null, maker varchar(50), supplier varchar(255), totalCost decimal(19,2) not null, unitPrice decimal(19,2), order_id bigint, item_category_id bigint, primary key (id));
...
create table storage (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, contactPersion varchar(50), location varchar(50), name varchar(50) not null, type varchar(50) not null, primary key (id));
create table storage_others (id bigint not null, primary key (id));
create table storage_section (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, name varchar(50), type varchar(50), storage_id bigint, primary key (id));
...
create table work_plan (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, planIdentity varchar(255), planType varchar(255), status varchar(255), managed_project_id bigint, primary key (id));
create table work_plan_item (id bigint not null auto_increment, created_date datetime, last_update_date datetime, updatedByUser varchar(255), version integer, endDate datetime, message varchar(255), startDate datetime, status varchar(255), subject varchar(255), work_plan_id bigint, primary key (id));
...
alter table WorkMonthlyPlan add index FK9F08F4E5981E6CC (id), add constraint FK9F08F4E5981E6CC foreign key (id) references work_plan (id);
alter table WorkWeeklyPlan add index FK3102E55B981E6CC (id), add constraint FK3102E55B981E6CC foreign key (id) references work_plan (id);
alter table WorkWeeklyPlan add index FK3102E55B7E9AE7DF (work_monthly_plan_id), add constraint FK3102E55B7E9AE7DF foreign key (work_monthly_plan_id) references WorkMonthlyPlan (id);
...
alter table managed_item add index FK31470FB3A9443F24 (storage_section_fk), add constraint FK31470FB3A9443F24 foreign key (storage_section_fk) references storage_section (id);
...
alter table work_plan add index FK40FE3F97C6E999B2 (managed_project_id), add constraint FK40FE3F97C6E999B2 foreign key (managed_project_id) references managed_project (id);
alter table work_plan_item add index FK36291ABB5CAD5074 (work_plan_id), add constraint FK36291ABB5CAD5074 foreign key (work_plan_id) references work_plan (id);

 ...
 * <pre>
 *      &lt;bean id="fooDao" class="com.focaplo.myfuse.dao.hibernate.GenericDaoHibernate"&gt;
...
//    protected SessionFactory sessionFactory;
    ...
    @SuppressWarnings("unchecked")
    public T get(PK id) {
        T entity = (T) this.getSessionFactory().getCurrentSession().get(this.persistentClass, id);
    ...
    public void remove(PK id) {
    	this.getSessionFactory().getCurrentSession().delete(this.get(id));
    }

...
public abstract class BaseDaoTestCase {
    ...
    public void setUp() throws Exception {
    	...
    	universalDao = (UniversalDao)this.getApplicationContext().getBean("universalDao");
    	userDao = (UserDao) this.getApplicationContext().getBean("userDao");
    	inventoryDao=(InventoryDao) this.getApplicationContext().getBean("inventoryDao");
    	projectDao=(ProjectDao)this.applicationContext.getBean("projectDao");
    	grantDao=(GrantDao)this.applicationContext.getBean("grantDao");

...
public class WorkMonthlyPlanFormController extends WorkPlanFormController {

	public WorkMonthlyPlanFormController() {
		super();
		setCommandClass(WorkMonthlyPlan.class);
		this.monthly=true;
	}
	...
	public ModelAndView onSubmit(HttpServletRequest request,
        ...
        if (request.getParameter("delete") != null) {
        	...
        	if(workPlan instanceof WorkWeeklyPlan){
                ...
                saveMessage(request, getText("workPlan.monthly.added", "" + workPlan.getId(), locale));
